          ...
          Stack(children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                fit: BoxFit.cover,
                image: AssetImage(
                  'assets/images/bgProScr.png',
                ),
              )),
            ),
            Positioned(top: 30.sp, left: 20.sp, child: BackButton()),
            Positioned(
                top: 110.sp,
                left: 130.sp,
                child: Container(
...
//                       image: AssetImage('assets/images/profileImage.png',))
          ...
          TextfieldComponent(titleText: 'Full Name', hinttext: 'User Name'),
          TextfieldComponent(titleText: 'E-mail', hinttext: 'User E-mail'),
          TextfieldComponent(titleText: 'Phone Number', hinttext: 'User Number')
          // RegistrationScreen()
        ],
      ),
    );
